...
public static class DebugTiles 
{
    ...
    public static void DebugFirstInstance(EnvTile[,] tileMatrix, Dictionary<ParentObject, GameObject> parentDictionary, Func<EnvTile, bool> tilePredicate) =>
    ...
    /// <param name="parentDictionary">Dictionary containing ParentObject references and corresponding GameObjects</param>
    /// <param name="tilePredicate">Injects predicate into where clause</param>
    public static void DebugAll(EnvTile[,] tileMatrix, Dictionary<ParentObject, GameObject> parentDictionary, Func<EnvTile, bool> tilePredicate) =>
        (from EnvTile tile in tileMatrix
