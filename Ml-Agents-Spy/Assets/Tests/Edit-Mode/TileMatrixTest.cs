...
namespace Tests
{
    public class TileMatrixTest
    {
        ...
        public void MatrixSizeTest()
        {
            ...
            TileMatrix tmTwo = new TileMatrix(new Vector3(0, 0, 0), MapScaleToMatrixSize(2));
            Assert.AreEqual(11, tmTwo.Tiles[0].Count);
            Assert.AreEqual(11, tmTwo.Tiles.Count);

            TileMatrix tmThree = new TileMatrix(new Vector3(0, 0, 0), MapScaleToMatrixSize(3));
            Assert.AreEqual(11, tmTwo.Tiles[0].Count);
            Assert.AreEqual(11, tmTwo.Tiles.Count);

            TileMatrix tmFour = new TileMatrix(new Vector3(0, 0, 0), MapScaleToMatrixSize(4));
